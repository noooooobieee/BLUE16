...
*/
header('Content-Type: application/json; charset=utf-8');
echo json_encode(['success' => false, 'message' => 'invite generate will be gone, and got replaced with discord linking this is useless, we may change our mind reusing it again.']);