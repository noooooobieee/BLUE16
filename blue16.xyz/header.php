...
<li><a class="dropdown-item" href="https://discord.gg/A9mv477NrP">Discord</a></li>
</ul>
</div>
</ul>
<div class="d-flex" id="currencydiv">
<a style="margin-right:10px;font-weight: 600;text-decoration: none;" href="/users/<?php echo $user_data['id']; ?>/profile"><img class="rounded-5 overflow-hidden me-2" width="32" height="32" src="https://cdn.discordapp.com/avatars/859791186617171998/4608e9ebd7475a701eba969a2ca1eae4.webp?size=1024&format=webp&width=0&height=320"><span><?php echo $user_data['username']; ?></span></a>
<a href="/transactions/"><span class="rbx-icon-nav-robux"></span></a>
<span class=""><?php echo $user_data['robux']; ?>500k</span>
<a href="/transactions/"><span class="rbx-icon-nav-tix"></span></a>
<span><?php echo $user_data['tickets']; ?>100</span>
