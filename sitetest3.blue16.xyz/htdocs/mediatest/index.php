...
<body>
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <select name="domain" id="domain">
            <option value="http://sitetest3.blue16.xyz/mediatest/">sitetest3.blue16.xyz</option>
    ...
    <p><a href="http://sitetest3.blue16.xyz/mediatest/public-files.php">View Public Files</a></p>
